...
def stock():
    ...
    return render_template("stockselect.html", chart_title=stockname, chart_data_all=chart_data_all, chart_data_all_sec=chart_data_all_sec,chart_data_all_th=chart_data_all_th, data_types=data_types, window=window, window2= window2,  rt_price= rt_price1, pred_price = pred_price, rec_BS = rec_BS)
